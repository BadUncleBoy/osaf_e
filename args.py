...
### Some paths
train_file = './data/my_data/kdxf/train.txt'  # The path of the training txt file.
val_file = './data/my_data/kdxf/val.txt'  # The path of the validation txt file.
...
[13 ,13], [26, 26], [52, 52]
'''
no_anchor_branch = [False, False, False]
anchor_branch = True
